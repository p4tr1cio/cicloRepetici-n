...
for x in range(3):
    print(f"se portaraon mal el sabado{x}")
...
#     promedio = contadorNota/cantidad # round(contadorNota/cantidad) 
#     promedioRedondeado = round(promedio, 1)
#     print(f"el resultado de las {cantidad} nota es :{promedioRedondeado}")
# except:
